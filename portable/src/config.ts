...
import { getUserDataDir } from "./portable/paths.js";

// .env loading is handled by portable/bootstrap.ts before this module runs.
...
export function getConfig(): Config {
  ...
  configCache = {
    ...
    userDataDir: process.env.USER_DATA_DIR || getUserDataDir(),
