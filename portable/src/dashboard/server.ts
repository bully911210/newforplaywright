...
import { getScreenshotDir } from "../portable/paths.js";
// esbuild inlines dashboard.html as a string via the text loader
// @ts-expect-error resolved at bundle time by esbuild
